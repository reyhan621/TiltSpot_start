...
public class MainActivity extends AppCompatActivity
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        mTextSensorAzimuth.setText(String.format(Locale.getDefault(), "%1$.2f", azimuth));
        mTextSensorPitch.setText(String.format(Locale.getDefault(), "%1$.2f", pitch));
        mTextSensorRoll.setText(String.format(Locale.getDefault(), "%1$.2f", roll));
